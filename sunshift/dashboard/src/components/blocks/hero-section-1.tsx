...
import {
  ...
  CloudLightning, DollarSign, BarChart3, Server, Lock,
...
const repoBlobUrl = `${repoUrl}/blob/main`;
const repoTreeUrl = `${repoUrl}/tree/main`;
...
// Florida business risk — real numbers that frame the problem
const riskStats = [
  {
    stat: '60%',
    label: 'of Florida SMBs never reopen after a natural disaster',
    source: 'FEMA',
  },
  {
    stat: '58%',
    label: 'of backups fail when recovery is actually attempted',
    source: '',
  },
  {
    stat: '11 days',
    label: 'without power for some Tampa businesses after Hurricane Milton',
    source: '2024',
  },
];

// Features organized into 3 outcome pillars — pain-first headlines, code links for depth
const features = [
  // — Pillar 1: Never Lose Your Data —
  {
    ...
    href: `${repoBlobUrl}/sunshift/backend/services/hurricane_shield.py`,
  ...
  },
  {
    ...
    href: `${repoBlobUrl}/docs/adr/004-hipaa-compliance.md`,
  ...
  // — Pillar 2: Never Go Down —
  {
    ...
    href: `${repoTreeUrl}/sunshift/agent`,
  ...
  // — Pillar 3: Never Overpay —
  {
    ...
    href: `${repoBlobUrl}/sunshift/backend/ml/model.py`,
  ...
  },
  {
    ...
    href: `${repoBlobUrl}/sunshift/backend/services/scheduler_service.py`,
    ctaLabel: 'View scheduler_service.py',
    external: true,
  },
];

// Architecture told as 3 story moments — what the user experiences, not what the system does
const architectureCards = [
  ...
  },
  {
    ...
    href: `${repoTreeUrl}/sunshift/backend`,
...
const adrLinks = [
  {
    ...
    href: `${repoBlobUrl}/docs/adr/001-hybrid-cloud-architecture.md`,
  },
  {
    id: 'ADR-002',
    title: 'AWS Ohio Destination',
    href: `${repoBlobUrl}/docs/adr/002-aws-ohio-destination.md`,
  },
  {
    id: 'ADR-003',
    title: 'TOU-Based Scheduling',
    href: `${repoBlobUrl}/docs/adr/003-tou-based-scheduling.md`,
  },
  {
    id: 'ADR-004',
  ...
  {
    id: 'ADR-005',
    title: 'Hurricane Shield',
    href: `${repoBlobUrl}/docs/adr/005-hurricane-shield.md`,
  },
];
